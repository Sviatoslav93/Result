...
{
    public static Error Failure(string code, string description) => new Error(code, description);
    public static Error Unexpected(string code, string description) => new Error(code, description, ErrorType.Unexpected);
